...
const Home = props => {
  ...
  const renderTabBar = props => <TabBar {...props} indicatorStyle={styles.indicator} indicatorContainerStyle={styles.indicatorContainer} labelStyle={styles.tabLabel} style={styles.tab} />;
