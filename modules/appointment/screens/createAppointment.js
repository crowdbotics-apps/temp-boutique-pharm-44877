...
import { createSlackChannel, createGoogleFolder, createHubSpotDeal } from "../api";
...
const CreateAppointment = ({
  ...
  const onCreateAppointment = async () => {
    ...
    const calendarInvite = {
      ...
      attachments: CREATE_SHARED_FOLDER && folder && [{
        fileId: folder.id,
        title: title
      }]
    };
      ...
      <ScrollView>
        ...
        <View style={styles.createAppointmentContainer}>
          ...
          <View style={styles.createButton}>
            <Button disabled={!!(!title || attendeesList.length === 0)} onPress={onCreateAppointment}>
              Create Appointment
            </Button>
          </View>
        </View>
