...
## Project Structure
    ...
    ├── temp_boutique_pharm_44877  # Django project configurations
...
1. Clone this repo and `cd temp_boutique_pharm_44877`
...
2. Clone this repo and `cd temp_boutique_pharm_44877`
